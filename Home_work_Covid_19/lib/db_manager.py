...
class db_manager:
    ...
    def __update_covid_data(self):
        ...
        value = (covid_data['Global']['NewConfirmed'], covid_data['Global']['TotalConfirmed'], covid_data['Global']['NewDeaths'], covid_data['Global']['TotalDeaths'], covid_data['Global']['NewRecovered'], covid_data['Global']['TotalRecovered'])
        ...
        for item in covid_data['Countries']:
            ...
            values = (item['Country'], item['CountryCode'], item['Slug'], item['NewConfirmed'], item['TotalConfirmed'], item['NewDeaths'], item['TotalDeaths'], item['NewRecovered'], item['TotalRecovered'], item['Date'])
